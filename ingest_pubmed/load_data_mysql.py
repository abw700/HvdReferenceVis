...
conn.execute("CREATE TABLE IF NOT EXISTS Journals (jid INTEGER PRIMARY KEY UNIQUE AUTO_INCREMENT, name text)")
conn.execute("CREATE TABLE IF NOT EXISTS Articles (pmid INTEGER PRIMARY KEY UNIQUE, title text, abstract text, pubyear integer, jid integer)")
conn.execute("CREATE TABLE IF NOT EXISTS Citations (cid INTEGER PRIMARY KEY UNIQUE AUTO_INCREMENT, apmid integer, bpmid integer)")
